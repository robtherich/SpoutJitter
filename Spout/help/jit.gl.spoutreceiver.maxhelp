...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 104.5, 159.0, 134.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 41.0, 35.0, 232.0, 94.0 ],
									"text" : "Spout 2.007 allows to send metadata with each frame. By specifying the expected buffersize of the metadata you can receive the frame_metadata message from the dump outlet"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 69.5, 218.0, 103.0, 22.0 ],
									"text" : "r frame_metadata"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 69.5, 328.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 69.5, 289.0, 111.0, 22.0 ],
									"text" : "route framenumber"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 69.5, 250.0, 71.0, 22.0 ],
									"text" : "fromsymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 69.5, 188.0, 72.0, 22.0 ],
									"text" : "s prerender"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 69.5, 131.0, 175.0, 22.0 ],
...
,
					"patching_rect" : [ 145.0, 112.0, 106.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 163.0, 89.0, 209.0, 20.0 ],
									"text" : "Receive textures from a Spout source"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 469.0, 61.0, 298.0, 48.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 163.0, 58.0, 192.0, 29.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 17.0, 15.0, 125.0, 123.53515625 ],
									"pic" : "icon.png"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 74.0, 267.0, 80.0, 36.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 17.0, 167.0, 24.0, 24.0 ],
									"svg" : ""
								}
...
,
									...
									"patching_rect" : [ 17.0, 200.0, 133.0, 22.0 ],
									"text" : "jit.world @size 640 360"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 600.0, 267.0, 105.0, 22.0 ],
									"text" : "s frame_metadata"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 670.0, 234.0, 34.0, 22.0 ],
									"text" : "print"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 255.0, 267.0, 60.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 530.0, 267.0, 37.0, 22.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 624.0, 378.0, 73.0, 42.0 ],
									"text" : "select sender"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 460.0, 431.0, 125.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 460.0, 234.0, 98.0, 22.0 ],
									"text" : "prepend append"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 460.0, 193.0, 229.0, 22.0 ],
									"text" : "route SpoutSender clear frame_metadata"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 460.0, 389.0, 158.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 183.0, 267.0, 70.0, 22.0 ],
									"text" : "r prerender"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 255.0, 295.0, 117.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 256.0, 339.0, 105.0, 22.0 ],
									"text" : "jit.gl.spoutreceiver"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 256.0, 389.0, 59.0, 22.0 ],
									"text" : "jit.gl.layer"
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 83.5, 252.0, 169.75, 252.0, 169.75, 333.0, 265.5, 333.0 ],
									"order" : 0,
									"source" : [ "obj-1", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-21", 0 ],
									"midpoints" : [ 192.5, 330.0, 265.5, 330.0 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 351.5, 382.0, 444.0, 382.0, 444.0, 180.0, 469.5, 180.0 ],
									"source" : [ "obj-21", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-21", 0 ],
									"midpoints" : [ 469.5, 469.0, 232.0, 469.0, 232.0, 330.0, 265.5, 330.0 ],
									"source" : [ "obj-31", 0 ]
								}
...
,
					"patching_rect" : [ 76.75, 112.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
